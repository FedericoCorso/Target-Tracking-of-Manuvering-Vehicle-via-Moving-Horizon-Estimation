...
function [z_est,d_est,comp_time] = MHE_Unc_EKF_Analytical(Ts,Ts_sim,N,nz,ny,nu,Msec,MHE_interval,R_camera,R_radar,Q,A_terminal,z_minus,myoptions,ymeas_camera,ymeas_radar)
...
for ind = M+1:MHE_interval:N
    ...
    myoptions.GN_funF       =  @(x)target_cost_GN_grad(x,nz,M,Ts,Ts_sim,ymeas_camera(:,ind-M:ind),...
