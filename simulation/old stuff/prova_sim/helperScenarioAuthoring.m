...
% roadTurn = pi/2;    % Create a road that turns 90 degrees
...
% numSamples = 300;   % Define the road with sample points
...
trajectory(vehicles(1), road1Centers(round(0.15*numSamples):end,:)+passingOffset, 16.6);
