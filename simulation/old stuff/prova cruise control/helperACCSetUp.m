%% General Model parameters & preceding vehicle manouvre
clear
close all

% addpath("../sim_data/");
% load("precVehicleData.mat"); % preceding vehicle dynamic trajectory
% precVehicleWaypoints = out.pose.signals.values;
% vxpw2 = (out.speed.signals.values(:,1)).^2;
% vypw2 = (out.speed.signals.values(:,2)).^2;
% precVehicleSpeed = sqrt(vxpw2+vypw2); % speed profile
...
[scenario,egoVehicle] = ACCTestBenchScenario(precVehicleWaypoints,precVehicleSpeed);
