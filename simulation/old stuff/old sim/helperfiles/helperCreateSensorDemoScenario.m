...
trajectory(egoCar,egoWaypoints,velWaypoints);
...
trajectory(leadCar,leadWaypoints,vel);
...
trajectory(passCar,passWaypoints,[passVel;passVel;passVel;vel;vel;vel]);
end
...
trajectory(egoCar,egoPath,speedEgo/3.6);
