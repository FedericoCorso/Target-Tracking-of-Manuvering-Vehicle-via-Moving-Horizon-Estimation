...
function out = target_cost_con(x,nz,M,Ts,Ts_sim,ymeas_camera,ymeas_radar,z_minus,R_camera,R_radar,Q,A_terminal,ego_pos,ego_or)
...
out = [cost;h]; % stack cost and constraints
