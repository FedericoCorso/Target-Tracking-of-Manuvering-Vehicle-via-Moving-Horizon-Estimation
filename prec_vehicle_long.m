function z_kplus1 = prec_vehicle_long(z_k,w_k,dk,th)
...
% matrices 
gamma = [dk 0;(1/2)*dk^2 -(1/2)*dk^2; 0 dk]; % 3x2
gamma_a = [0 0 0; C1 C2 C3-C1]; % 2x3
C = [0; z_k(5,1)]; % 2x1
F = [1 0 0; dk 1 -dk; 0 0 1]; % 3x3
A = F + gamma*gamma_a; % 3x3

% matrices augmented state
F_bar = [A gamma; zeros(2,3) eye(2)]; % 5x5
gamma_bar = [gamma; zeros(2,2)];
